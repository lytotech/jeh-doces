    ...
    <div className="min-h-screen bg-[#FAF7F2] pb-24">
      ...
      <div className="max-w-md mx-auto p-4 sm:p-5 space-y-4">
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="bg-[#FCFAF8] p-3 border border-[#E5DACD] rounded-2xl shadow-xs">
            <Switch
          ...
          {isComposite && (
            <div className="p-4 bg-[#F5EFE6] rounded-2xl border border-[#DFCFC0] space-y-3 animate-fadeIn">
          ...
          <div className="p-3 bg-[#FAF5EE] border border-[#E7D5BF] rounded-2xl flex items-center justify-between">
            <span className="text-xs font-semibold text-[#7A4B1D]">
              Custo calculado por {unit}:
            </span>
            <span className="text-base font-bold text-[#96642F]">
              {formatCurrency(computedUnitCost)} / {unit}
            </span>
          </div>
        ...
        {isEditing && ingredient && (
          <div className="pt-1">
            <Button
              ...
              className="border-[1.5px] border-[#96642F] bg-[#FCFAF8]"
            >
              <TrendingUp className="w-5 h-5 mr-2 stroke-[2.2]" /> Histórico de preço
            </Button>
          </div>
        )}
      </div>
