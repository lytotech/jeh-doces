  ...
  return (
    <>
      <div className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] right-4 z-30 w-[min(22rem,calc(100vw-2rem))] rounded-2xl border border-[#E7B84B] bg-[#FFFDF2] p-3 text-[#654A12] shadow-lg shadow-[#654A12]/10 md:bottom-5 md:right-6">
        ...
        <div className="mt-2.5 flex gap-2 pl-6"><button disabled={loading} onClick={() => void createPayment('monthly')} className="rounded-lg bg-[#8D3157] px-2.5 py-1.5 text-[11px] font-bold text-white">R$ 9,90/mês</button><button disabled={loading} onClick={() => void createPayment('annual')} className="rounded-lg bg-[#6B1F3B] px-2.5 py-1.5 text-[11px] font-bold text-white">R$ 89,90/ano</button></div>
      </div>
