...
export const calculateIngredientUnitCost = (paidPrice, packageQuantity, isComposite, subIngredients, allIngredients = [], yieldQuantity = 1) => {
...
export const calculateMaterialUnitCost = (totalCost, baseQuantity) => {
    if (baseQuantity <= 0)
        return 0;
    return totalCost / baseQuantity;
};
export const calculateProductCost = (product, ingredients, materials) => {
    let cost = 0;
    // Ingredients cost
